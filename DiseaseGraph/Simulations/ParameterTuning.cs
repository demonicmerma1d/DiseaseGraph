...
namespace DiseaseGraph.Simulations
{
    public static class ParameterTuning
    {
        ...
        {
            NodeCountAveInfectPlot([.. Enumerable.Range(0,250).Select(x => 2*x+500)], 25, proportion, [0.002,0.005,0.01], aveNodeDegree);
        }
        ...
        public static void InfectionProportionParamTuning()
        {
            int nodeCount = 1000;
            int repeatCount = 25;
            double baseInfectionChance = 0.005;
            int start = 10;
            int end = 35;
        ...
        {
            RunParams runParams = new(1, 1);
            var graph = new ERGraph<IncubateNode>(1000, EdgeDensity(1000, 3), 0.01, 0.005, 1);
            graph.RunRandom(100, runParams);
        ...
        public static void BaseInfectionChanceParamTuning()
        {
            int nodeCount = 1000;
            int repeatCount = 25;
            double[] baseInfectionChances = [.. Enumerable.Range(0, 401).Select(x => (double)x / 80000)];
